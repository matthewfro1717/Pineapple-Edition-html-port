function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'kahrahtae' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'kahrahtae_assets'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'missHealth', 500); --Change amount of health to take when you miss like a fucking moron
		end
	end
